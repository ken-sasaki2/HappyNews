...
class AppGameNewsTableViewController: UITableViewController,SegementSlideContentScrollViewDelegate, XMLParserDelegate{
    ...
    override func viewDidLoad() {
        ...
        //XMLParseの処理
        //XMLファイルを特定
        let xmlString = "https://www.inside-games.jp/rss/index.rdf"
