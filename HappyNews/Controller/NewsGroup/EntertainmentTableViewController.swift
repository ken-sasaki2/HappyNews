...
//        
//        //感情分析結果の保存
//        userDefaults.set(arrayAnalyzerData, forKey: "joyCountArray2")
//        
//        //UIの更新を行うメソッドの呼び出し
//        reloadNewsData()
//    }
...
//        
//        //感情分析結果の取り出し
//        joyCountArray = userDefaults.array(forKey: "joyCountArray2") as! [Int]
...
//            if userDefaults.string(forKey: "morningUpdate2") == nil {
//                print("朝のAPI通信")
//                //朝のAPI更新
//                startTranslation()
//                
//                //UserDefaultsで値を保存して次回起動時キャッシュ表示に備える
//                userDefaults.set("朝のAPI通信完了", forKey: "morningUpdate2")
//                
//                //次回時間割に備えてUserDefaultsに保存した値を削除
//                userDefaults.removeObject(forKey: "lateAtNightTimeUpdate2")
//                userDefaults.removeObject(forKey: "afternoonUpdate2")
//                userDefaults.removeObject(forKey: "eveningUpdate2")
//            } else {
//                
...
//            if userDefaults.string(forKey: "afternoonUpdate2") == nil {
//                print("昼のAPI通信")
//                //昼のAPI更新
//                startTranslation()
//                
//                //UserDefaultsで値を保存して次回起動時キャッシュ表示に備える
//                userDefaults.set("昼のAPI通信完了", forKey: "afternoonUpdate2")
//
//                //次回時間割に備えてUserDefaultsに保存した値を削除
//                userDefaults.removeObject(forKey: "morningUpdate2")
//                userDefaults.removeObject(forKey: "eveningUpdate2")
//                userDefaults.removeObject(forKey: "lateAtNightTimeUpdate2")
//            } else {
//                print("キャッシュの表示")
...
//            if userDefaults.string(forKey: "eveningUpdate2") == nil {
//                print("夕方のAPI通信（日付変更以前）")
//                //夕方のAPI更新（日付変更以前）
//                startTranslation()
//                
//                //UserDefaultsで値を保存して次回起動時キャッシュ表示に備える
//                userDefaults.set("夕方のAPI通信完了（日付変更以前）", forKey: "eveningUpdate2")
//                
//                //次回時間割に備えてUserDefaultsに保存した値を削除
//                userDefaults.removeObject(forKey: "afternoonUpdate2")
//                userDefaults.removeObject(forKey: "lateAtNightTimeUpdate2")
...
//                
//                //429エラーが多発して解析を中断した後に起動した際の処理
//                if userDefaults.object(forKey: "Multiple 429 errors") != nil {
//                    
//                    //改めて感情分析をおこなう
//                    startTranslation()
//                } else {
...
//            if userDefaults.string(forKey: "lateAtNightTimeUpdate2") == nil {
//                print("夕方のAPI通信（日付変更以降）")
//                //夕方のAPI更新（日付変更以降）
//                startTranslation()
//                
//                //UserDefaultsで値を保存して次回起動時キャッシュ表示に備える
//                userDefaults.set("夕方のAPI通信完了（日付変更以降）", forKey: "lateAtNightTimeUpdate2")
//                
//                //次回時間割に備えてUserDefaultsに保存した値を削除
//                userDefaults.removeObject(forKey: "eveningUpdate2")
//                userDefaults.removeObject(forKey: "morningUpdate2")
