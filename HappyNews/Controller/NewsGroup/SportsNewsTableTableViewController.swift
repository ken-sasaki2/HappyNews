////
////  SportsNewsTableTableViewController.swift
////  HappyNews
////
...
//import Kingfisher
//
//class SportsNewsTableTableViewController: UITableViewController,SegementSlideContentScrollViewDelegate, XMLParserDelegate, DoneCatchTranslationProtocol, DoneCatchAnalyzerProtocol {
//    
//    //XMLParserのインスタンスを作成
...
//        xmlString = "https://news.yahoo.co.jp/rss/media/tvtokyos/all.xml"
//        
//        //XMLファイルをURL型のurlに変換
...
//        
//        //感情分析結果の保存
//        userDefaults.set(arrayAnalyzerData, forKey: "joyCountArray1")
//        
//        //UIの更新を行うメソッドの呼び出し
//        reloadNewsData()
//    }
...
//        
//        //感情分析結果の取り出し
//        joyCountArray = userDefaults.array(forKey: "joyCountArray1") as! [Int]
