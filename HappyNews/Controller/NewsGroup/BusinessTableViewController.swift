...
//import Kingfisher
//
//class BusinessTableViewController: UITableViewController,SegementSlideContentScrollViewDelegate, XMLParserDelegate, DoneCatchTranslationProtocol, DoneCatchAnalyzerProtocol {
//    
//    //XMLParserのインスタンスを作成
...
//    
//    //ToneAnalyzerの認証キー
//    var toneAnalyzerApiKey  = "CTEJh0FDiov9U4VQ3IKZ0dvoMw6Ekk2Ams6bf-XbtKsV"
...
//        
//        //感情分析結果の保存
//        userDefaults.set(arrayAnalyzerData, forKey: "joyCountArray3")
//        
//        //UIの更新を行うメソッドの呼び出し
//        reloadNewsData()
//    }
...
//        
//        //感情分析結果の取り出し
//        joyCountArray = userDefaults.array(forKey: "joyCountArray3") as! [Int]
...
//            if userDefaults.string(forKey: "morningUpdate3") == nil {
//                print("朝のAPI通信")
//                //朝のAPI更新
//                startTranslation()
//                
//                //UserDefaultsで値を保存して次回起動時キャッシュ表示に備える
//                userDefaults.set("朝のAPI通信完了", forKey: "morningUpdate3")
//                
//                //次回時間割に備えてUserDefaultsに保存した値を削除
//                userDefaults.removeObject(forKey: "lateAtNightTimeUpdate3")
//                userDefaults.removeObject(forKey: "afternoonUpdate3")
//                userDefaults.removeObject(forKey: "eveningUpdate3")
//            } else {
//                
...
//            if userDefaults.string(forKey: "afternoonUpdate3") == nil {
//                print("昼のAPI通信")
//                //昼のAPI更新
//                startTranslation()
//                
//                //UserDefaultsで値を保存して次回起動時キャッシュ表示に備える
//                userDefaults.set("昼のAPI通信完了", forKey: "afternoonUpdate3")
//
//                //次回時間割に備えてUserDefaultsに保存した値を削除
//                userDefaults.removeObject(forKey: "morningUpdate3")
//                userDefaults.removeObject(forKey: "eveningUpdate3")
//                userDefaults.removeObject(forKey: "lateAtNightTimeUpdate3")
//            } else {
//                print("キャッシュの表示")
...
//            if userDefaults.string(forKey: "eveningUpdate3") == nil {
//                print("夕方のAPI通信（日付変更以前）")
//                //夕方のAPI更新（日付変更以前）
//                startTranslation()
//                
//                //UserDefaultsで値を保存して次回起動時キャッシュ表示に備える
//                userDefaults.set("夕方のAPI通信完了（日付変更以前）", forKey: "eveningUpdate3")
//                
//                //次回時間割に備えてUserDefaultsに保存した値を削除
//                userDefaults.removeObject(forKey: "afternoonUpdate3")
//                userDefaults.removeObject(forKey: "lateAtNightTimeUpdate3")
...
//            if userDefaults.string(forKey: "lateAtNightTimeUpdate3") == nil {
//                print("夕方のAPI通信（日付変更以降）")
//                //夕方のAPI更新（日付変更以降）
//                startTranslation()
//                
//                //UserDefaultsで値を保存して次回起動時キャッシュ表示に備える
//                userDefaults.set("夕方のAPI通信完了（日付変更以降）", forKey: "lateAtNightTimeUpdate3")
//                
//                //次回時間割に備えてUserDefaultsに保存した値を削除
//                userDefaults.removeObject(forKey: "eveningUpdate3")
//                userDefaults.removeObject(forKey: "morningUpdate3")
