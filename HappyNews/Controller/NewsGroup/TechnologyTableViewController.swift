...
//import Kingfisher
//
//class TechnologyTableViewController: UITableViewController,SegementSlideContentScrollViewDelegate, XMLParserDelegate, DoneCatchTranslationProtocol, DoneCatchAnalyzerProtocol {
//    
//    //XMLParserのインスタンスを作成
...
//    
//    //ToneAnalyzerの認証キー
//    var toneAnalyzerApiKey  = "9cdZn72op0WTFdJF9zTNUTn4dd2nQaQV-Ag8G-C9I6IW"
...
//        
//        //感情分析結果の保存
//        userDefaults.set(arrayAnalyzerData, forKey: "joyCountArray4")
//        
//        //UIの更新を行うメソッドの呼び出し
//        reloadNewsData()
//    }
...
//        
//        //感情分析結果の取り出し
//        joyCountArray = userDefaults.array(forKey: "joyCountArray4") as! [Int]
...
//            if userDefaults.string(forKey: "morningUpdate4") == nil {
//                print("朝のAPI通信")
//                //朝のAPI更新
//                startTranslation()
//                
//                //UserDefaultsで値を保存して次回起動時キャッシュ表示に備える
//                userDefaults.set("朝のAPI通信完了", forKey: "morningUpdate4")
//                
//                //次回時間割に備えてUserDefaultsに保存した値を削除
//                userDefaults.removeObject(forKey: "lateAtNightTimeUpdate4")
//                userDefaults.removeObject(forKey: "afternoonUpdate4")
//                userDefaults.removeObject(forKey: "eveningUpdate4")
//            } else {
//                print("キャッシュの表示")
//                reloadNewsData()
//            }
...
//            if userDefaults.string(forKey: "afternoonUpdate4") == nil {
//                print("昼のAPI通信")
//                //昼のAPI更新
//                startTranslation()
//                
//                //UserDefaultsで値を保存して次回起動時キャッシュ表示に備える
//                userDefaults.set("昼のAPI通信完了", forKey: "afternoonUpdate4")
//
//                //次回時間割に備えてUserDefaultsに保存した値を削除
//                userDefaults.removeObject(forKey: "morningUpdate4")
//                userDefaults.removeObject(forKey: "eveningUpdate4")
//                userDefaults.removeObject(forKey: "lateAtNightTimeUpdate4")
//            } else {
//                print("キャッシュの表示")
...
//            if userDefaults.string(forKey: "eveningUpdate4") == nil {
//                print("夕方のAPI通信（日付変更以前）")
//                //夕方のAPI更新（日付変更以前）
//                startTranslation()
//                
//                //UserDefaultsで値を保存して次回起動時キャッシュ表示に備える
//                userDefaults.set("夕方のAPI通信完了（日付変更以前）", forKey: "eveningUpdate4")
//                
//                //次回時間割に備えてUserDefaultsに保存した値を削除
//                userDefaults.removeObject(forKey: "afternoonUpdate4")
//                userDefaults.removeObject(forKey: "lateAtNightTimeUpdate4")
...
//            if userDefaults.string(forKey: "lateAtNightTimeUpdate4") == nil {
//                print("夕方のAPI通信（日付変更以降）")
//                //夕方のAPI更新（日付変更以降）
//                startTranslation()
//                
//                //UserDefaultsで値を保存して次回起動時キャッシュ表示に備える
//                userDefaults.set("夕方のAPI通信完了（日付変更以降）", forKey: "lateAtNightTimeUpdate4")
//                
//                //次回時間割に備えてUserDefaultsに保存した値を削除
//                userDefaults.removeObject(forKey: "eveningUpdate4")
//                userDefaults.removeObject(forKey: "morningUpdate4")
