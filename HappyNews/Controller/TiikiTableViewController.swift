...
class TiikiTableViewController: UITableViewController,SegementSlideContentScrollViewDelegate, XMLParserDelegate{
    ...
    override func viewDidLoad() {
        ...
        //XMLParseの処理
        //XMLファイルを特定
        let xmlString = "http://news.goo.ne.jp/rss/topstories/nation/index.rdf"
