...
class WorldNewsTableViewController: UITableViewController,SegementSlideContentScrollViewDelegate, XMLParserDelegate{
    ...
    override func viewDidLoad() {
        ...
        //XMLParseの処理
        //XMLファイルを特定
        let xmlString = "https://headlines.yahoo.co.jp/rss/abema-c_int.xml"
