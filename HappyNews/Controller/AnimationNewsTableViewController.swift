...
class AnimationNewsTableViewController: UITableViewController,SegementSlideContentScrollViewDelegate, XMLParserDelegate{
    ...
    override func viewDidLoad() {
        ...
        //XMLParseの処理
        //XMLファイルを特定
        let xmlString = "https://headlines.yahoo.co.jp/rss/anmanmv-c_ent.xml"
