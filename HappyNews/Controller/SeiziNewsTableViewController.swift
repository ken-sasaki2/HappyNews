...
class SeiziNewsTableViewController: UITableViewController,SegementSlideContentScrollViewDelegate, XMLParserDelegate{
    ...
    override func viewDidLoad() {
        ...
        //XMLParseの処理
        //XMLファイルを特定
        let xmlString = "https://www.zakzak.co.jp/rss/news/politics.xml"
